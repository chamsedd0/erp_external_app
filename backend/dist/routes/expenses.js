...
router.get('/pending', async (req, res) => {
    try {
        ...
        const expenses = await client_1.odooClient.searchRead(uid, 'hr.expense', [['state', 'in', ['draft', 'reported']]], ['id', 'name', 'product_id', 'price_unit', 'quantity', 'total_amount', 'date', 'state', 'create_date', 'description']);
